...
# update writing to diagnostic frequency 
two_weeks = 1209600
# 3D file 
update_param("data.diagnostics", "diagnostics_list", "frequency(1)", two_weeks*5)
# PC file 
update_param("data.diagnostics", "diagnostics_list", "frequency(11)", two_weeks*5)


# timing 
update_param("data", "PARM03", "nenditer", 2880*50) # end after 1 years
...
# # southern ocean (south) of hawaii 
# x = 203
# y = 30
