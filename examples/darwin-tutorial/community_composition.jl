...
#coords = [[203, 120], [203, 125], [203, 130], [203, 135], [203, 140], [203, 145]]
coords = [[203, 115], [203, 120], [203, 125], [203, 130], [203, 135], [203, 140], [203, 145]]
...
# # write to SINGLE dataset for each lat,lon seed point 
...
#     data_folder = "ecco_gud_20220906_0001" # CHANGE ME
#     rundir = joinpath(folder, config_id, "run")
#     glob_dir = joinpath(rundir, data_folder)
#     alldata = glob("3d*.nc", glob_dir) # all 20 years 
#     ds = Dataset(alldata)
#     write("3d.gradients-all-plankton-AUG-20yrs-$lon-$lat.nc", ds)
#     println("done with $lon, $lat")
# end
